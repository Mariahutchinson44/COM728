...
def read_data():
    with open('titanic.csv') as file:
        ...
        # read the csv file and append to dictionary
...
def plot_sex_vs_survival(ax, data):
    # create dictionaries for males and females for survived vs deceased
...
def plot_age_vs_survival(ax, data):
    # create dictionaries for each age group, children, adults, elderly
...
def plot_fare_vs_survived(ax, data):
    # create lists for survived and deceased

    survived = []
    deceased = []
    # append fare to lists
...
def run():
    data = read_data()
    # arrange as 2 x 2 grid
    fig, axs = plt.subplots(2, 2)
    # share same x-axis?
    # display plots
    # first plot sex vs survived
    plot_sex_vs_survival(axs[0, 0], data)
    plot_age_vs_survival(axs[0, 1], data)
    plot_fare_vs_survived(axs[1, 0], data)
